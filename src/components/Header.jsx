...
const Header = () => {
  ...
  const handleNavigate = (e) => {
    ...
    else if (e.target.innerHTML === "Prizes And Certifications") {
    ...
    else if (e.target.innerHTML === "Areas Of Interest") {
      setTimeout(() => {
        setMenuState(false);
        setIsMounted(false);
        navigate("/areasofinterest");
      }, 1000);
    }
  };
  ...
  return (
    <div className="header">
      <nav>
        ...
        {currentRoute === "/home"||currentRoute === "/honors" ? null : (
        ...
        {currentRoute==="/honors" ? null:(<div className="toggle-main">
            <input
